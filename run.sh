...
python train.py --world-size 1 --rank 0 --num_labels 300 --save_name scratch_300_0004 --dataset cifar10 --num_classes 10 --lr 0.0004 --net resnet50 --net_from_name True --eval_batch_size 10 --gpu 1
